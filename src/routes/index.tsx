  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Загородный отель «Голубая Бухта» — Мурманск, берег Туломы" },
      {
        ...
        content: "Коттеджи и блоки таунхауса на 2–12 гостей, русская баня на дровах, купель фурако, беседки, трансфер и сезонные активности в 40 км от Мурманска.",
      },
...
const ROUTE_CARDS: RouteCard[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      ["Октябрьский район", "3 700 ₽"],
      ["Ленинский район", "4 200 ₽"],
      ["Аэропорт", "4 200 ₽"],
    ],
  },
  {
